...
/**
 * Admin sidebar bell: unread badge (30s polling) + dropdown.
 * Item click -> read mark + order detail / seller detail.
 */
const NotificationBell = () => {
  ...
  const openItem = (n) => {
    ...
    setOpen(false);
    if (n.data?.sellerId) navigate(`/sellers/${n.data.sellerId}`);
    else if (n.data?.orderId) navigate(`/orders/${n.data.orderId}`);
